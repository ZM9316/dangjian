...
public class SetXXActivity extends BaseActivity {
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_set_xx;
    }

    @Override
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(SetXXActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        String url = UrlUtil.FATHER_HTML+ UrlUtil.SETMESSAGE + UrlUtil.getWithNo(this);
        mBigEventsSearchIv.setVisibility(View.GONE);
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, SetXXActivity.this, "android");
