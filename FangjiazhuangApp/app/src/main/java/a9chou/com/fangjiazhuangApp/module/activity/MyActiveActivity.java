...
public class MyActiveActivity extends BaseActivity {
    ...
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(MyActiveActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();


        mBigEventsTitleTitle.setText("我的活动");
        mBigEventsSearchIv.setVisibility(View.GONE);
        String url = UrlUtil.FATHER_HTML + UrlUtil.MYACTIVE + UrlUtil.getWithNo(this);
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, MyActiveActivity.this, "android");
