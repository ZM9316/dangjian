...
public class TyxxActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_tyxx)
    LinearLayout mActivityTyxx;
    private LoadingDailog mDialog;

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_tyxx;
    }

    @Override
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(TyxxActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
         String url = UrlUtil.FATHER_HTML + UrlUtil.TYXX + UrlUtil.getWithHas(this);


        mShykXz.setVisibility(View.GONE);
        mShykTitleTitle.setText("团员信息");
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, TyxxActivity.this, "android");
