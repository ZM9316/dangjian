...
public class SjglActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_sjgl)
    LinearLayout mActivitySjgl;
    private LoadingDailog mDialog;

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_sjgl;
    }

    @Override
    protected void initViews() {
         String url =UrlUtil.FATHER_HTML+UrlUtil.SJGL+UrlUtil.getWithHas(this);
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(SjglActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();

        mShykXz.setVisibility(View.GONE);
        mShykTitleTitle.setText("审计管理");
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, SjglActivity.this, "android");
