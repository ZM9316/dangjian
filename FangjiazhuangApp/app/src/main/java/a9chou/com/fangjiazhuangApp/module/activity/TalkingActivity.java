...
public class TalkingActivity extends BaseActivity {
    ...
    protected void initViews() {
        String url = UrlUtil.FATHER_HTML + UrlUtil.THTX + UrlUtil.getWithNo(this);
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(TalkingActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
...
//        设置支持js
        WebViewUtils.setWebView(mDialog, mWeb, url, TalkingActivity.this, "android");
