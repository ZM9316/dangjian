...
public class KhnrActivity extends BaseActivity {
    ...
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(KhnrActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        shykTitleTitle.setText("考核内容");
        shykXz.setVisibility(View.GONE);
        String url = UrlUtil.FATHER_HTML + UrlUtil.EXAMINATION_CNTENT + UrlUtil.getWithNo(this);
        Log.i("url",url);
        //        设置支持js
        WebViewUtils.setWebView(mDialog, web, url, KhnrActivity.this, "android");
