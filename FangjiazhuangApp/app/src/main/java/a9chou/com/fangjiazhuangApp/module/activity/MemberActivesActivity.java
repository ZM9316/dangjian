...
public class MemberActivesActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_tqqgzgl)
    LinearLayout mActivityTqqgzgl;
    private LoadingDailog mDialog;

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_member_actives;
    }

    @Override
    protected void initViews() {

        String url = UrlUtil.FATHER_HTML + UrlUtil.TQHD + UrlUtil.getWithHas(this);

        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(MemberActivesActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        ...
        mShykTitleTitle.setText("团青活动");
        //        设置支持js
        WebViewUtils.setWebView(mDialog, mWeb, url, MemberActivesActivity.this, "android");
