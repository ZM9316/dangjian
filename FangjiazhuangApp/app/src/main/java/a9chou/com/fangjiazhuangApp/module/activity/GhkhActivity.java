...
public class GhkhActivity extends BaseActivity {
    ...
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(GhkhActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        shykTitleTitle.setText("工会考核");
        shykXz.setVisibility(View.GONE);
        String url = UrlUtil.FATHER_HTML + UrlUtil.LABOUR_UNION_ASSESSMENT + UrlUtil.getWithNo(this);
        Log.i("url",url);
        //        设置支持js
        WebViewUtils.setWebView(mDialog, web, url, GhkhActivity.this, "android");
