...
public class ZdjsActivity extends BaseActivity {
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_zdjs;
    }

    @Override
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(ZdjsActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        String url = UrlUtil.FATHER_HTML + UrlUtil.ZDJS + UrlUtil.getWithNo(this);

        mBigEventsTitleTitle.setText("制度建设");
        WebViewUtils.setWebView(mDialog, mWeb, url, ZdjsActivity.this, "android");
