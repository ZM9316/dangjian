...
public class XnjcActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_xnjc)
    LinearLayout mActivityXnjc;
    private LoadingDailog mDialog;

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_xnjc;
    }
    @Override
    protected void initViews() {
         String url =UrlUtil.FATHER_HTML+UrlUtil.XNJC+UrlUtil.getWithHas(this);
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(XnjcActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();

        mShykXz.setVisibility(View.GONE);
        mShykTitleTitle.setText("效能监察");
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, XnjcActivity.this, "android");
