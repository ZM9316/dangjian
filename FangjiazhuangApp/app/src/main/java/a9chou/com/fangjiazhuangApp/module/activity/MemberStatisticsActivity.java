...
public class MemberStatisticsActivity extends BaseActivity {
    ...
    protected void initViews() {
        mBigEventsTitleTitle.setText("团员统计");
        mBigEventsSearchIv.setVisibility(View.GONE);


        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(MemberStatisticsActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        mDialog.show();
        String url = UrlUtil.FATHER_HTML + UrlUtil.MEMBER_STATISTICS + UrlUtil.getWithNo(this);
        //        设置支持js
        WebViewUtils.setWebView(mDialog, mWeb, url, MemberStatisticsActivity.this, "android");
