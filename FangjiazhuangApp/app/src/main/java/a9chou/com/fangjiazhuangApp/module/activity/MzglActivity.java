...
public class MzglActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_mzgl)
    LinearLayout mActivityMzgl;
    ...
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(MzglActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        String url = UrlUtil.FATHER_HTML + UrlUtil.MZGL + UrlUtil.getWithHas(this);

        mShykXz.setVisibility(View.GONE);
        mShykTitleTitle.setText("民主管理");
        //        设置支持js
        WebViewUtils.setWebView(mDialog, mWeb, url, MzglActivity.this, "android");
