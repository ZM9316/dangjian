...
public class ServiceOraginationActivity extends BaseActivity {
    ...
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(ServiceOraginationActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        shykTitleTitle.setText("服务型党组织");
        shykXz.setVisibility(View.GONE);
        String url = UrlUtil.FATHER_HTML + UrlUtil.SERVICE_ORAGIZATION + UrlUtil.getWithNo(this);
        Log.i("url",url);
        //        设置支持js
        WebViewUtils.setWebView(mDialog, web, url, ServiceOraginationActivity.this, "android");
