...
public class PayActivity extends BaseActivity {
    ...
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(PayActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        String url = UrlUtil.FATHER_HTML + UrlUtil.DFGL + UrlUtil.getWithNo(this);
        mShykXz.setVisibility(View.GONE);

//        设置支持js
        WebViewUtils.setWebView(mDialog, mWeb, url, PayActivity.this, "android");
