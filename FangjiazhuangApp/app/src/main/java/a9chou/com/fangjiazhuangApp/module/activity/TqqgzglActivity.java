...
public class TqqgzglActivity extends BaseActivity {
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_tqqgzgl;
    }

    @Override
    protected void initViews() {

        String url = UrlUtil.FATHER_HTML + UrlUtil.TQGZGL + UrlUtil.getWithHas(this);

        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(TqqgzglActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        ...
        mShykTitleTitle.setText("团青工作管理");
        //        设置支持js
        WebViewUtils.setWebView(mDialog, mWeb, url, TqqgzglActivity.this, "android");
