...
public class LdbhActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_ldbh)
    LinearLayout mActivityLdbh;
    private LoadingDailog mDialog;


    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_ldbh;
    }

    @Override
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(LdbhActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        String url = UrlUtil.FATHER_HTML + UrlUtil.LDBH + UrlUtil.getWithHas(this);


        mShykXz.setVisibility(View.GONE);
        mShykTitleTitle.setText("劳动保护");
        //        设置支持js
        WebViewUtils.setWebView(mDialog, mWeb, url, LdbhActivity.this, "android");
