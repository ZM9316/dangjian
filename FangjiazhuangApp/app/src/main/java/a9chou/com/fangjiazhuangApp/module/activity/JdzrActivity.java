...
public class JdzrActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_jdzr)
    LinearLayout mActivityJdzr;
    private LoadingDailog mDialog;

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_jdzr;
    }

    @Override
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(JdzrActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();


        String url =UrlUtil.FATHER_HTML+UrlUtil.JDZR+UrlUtil.getWithHas(this);


        mShykXz.setVisibility(View.GONE);
        mShykTitleTitle.setText("监督责任");
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, JdzrActivity.this, "android");
