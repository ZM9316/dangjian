...
public class ZrzcActivity extends BaseActivity {
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_zrzc;
    }

    @Override
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(ZrzcActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        mShykTitleTitle.setText("转入转出");
        mShykXz.setVisibility(View.GONE);
        String url =UrlUtil.FATHER_HTML + UrlUtil.ZRZC + UrlUtil.getWithHas(this);
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, ZrzcActivity.this, "android");
