...
public class PartyServiceActivity extends BaseActivity {
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_party_service;
    }
    ...
    protected void initViews() {
        ...
        String url =UrlUtil.FATHER_HTML + UrlUtil.PARTY_SERVICE + UrlUtil.getWithNo(this);

        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(PartyServiceActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
            mBigEventsSearchIv.setVisibility(View.GONE);
        mBigEventsTitleTitle.setText("党员服务");
        WebViewUtils.setWebView(mDialog,mWeb, url, PartyServiceActivity.this, "android");
