...
public class NgjsActivity extends BaseActivity {
    ...
    @BindView(R.id.web)
    WebView mWeb;
    @BindView(R.id.activity_ngjs)
    LinearLayout mActivityNgjs;
    private LoadingDailog mDialog;

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_ngjs;
    }

    @Override
    protected void initViews() {
        LoadingDailog.Builder loadBuilder = new LoadingDailog.Builder(NgjsActivity.this)
                .setMessage("加载中...")
                .setCancelable(true);
        mDialog = loadBuilder.create();
        String url =UrlUtil.FATHER_HTML+UrlUtil.VGJS+UrlUtil.getWithHas(this);


        mShykXz.setVisibility(View.GONE);
        mShykTitleTitle.setText("女工建设");
        //        设置支持js
        WebViewUtils.setWebView(mDialog,mWeb, url, NgjsActivity.this, "android");
